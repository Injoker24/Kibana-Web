...
import { NewUserDataWrapper } from 'models';

interface Props {
  onSubmit: (data: NewUserDataWrapper) => void;
}

const UserInformationV2: React.FC<Props> = ({ onSubmit }) => {
...
export default UserInformationV2;
