...
const PINInformation: React.FC<Props> = ({
    onSubmit
}) => {
    ...
    return (<form onSubmit={handleSubmit(submitForm)}>
        <PageBody>
            <FormInput label="Buat PIN Sakuku"
                labelFor={'pin'}
                ...
                <Controller
                    ...
                    maxLength={6}
                    className={`form-control secure-input ${(formState.touched.pin === true && !!errors.pin) ? 'is-invalid' : ''}`}
                    autoComplete={'off'}
                />
            </FormInput>

            <FormInput label="Ulangi PIN Sakuku"
                labelFor={'rePin'}
                ...
                <Controller
                    ...
                    placeholder="6 digit angka"
                    maxLength={6}
                    className={`form-control secure-input ${(formState.touched.rePin === true && !!errors.rePin) ? 'is-invalid' : ''}`}
                    autoComplete={'off'}
                />
            </FormInput>
        </PageBody>
